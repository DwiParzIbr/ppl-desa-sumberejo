            ...
            <div class="card text-bg-light mb-3">
                <div class="card-body">
                    <a href="/dashboard">
                        ...
                        </svg></a> / <a href="/dashboard/wisata">Manajemen Wisata</a> / {!! \Illuminate\Support\Str::limit($wisata->judul, 50, $end = '...') !!}
                </div>
            </div>
            <div class="row">
                <div class="col-md-9 col-sm-12">
                    <h2 style="color:rgb(7, 102, 173);"><b>{{ $wisata->judul }}</b></h2>
                    ...
                    <div class="row" style="text-align: justify;text-justify: inter-word;">
                        ...
                        <img src="{{ asset('images/' . $wisata->thumbnail) }}" class="rounded"
