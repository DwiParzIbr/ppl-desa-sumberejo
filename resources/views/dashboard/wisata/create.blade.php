            ...
            <div class="card text-bg-light mb-3">
                <div class="card-body">
                    <a href="/dashboard">
                        ...
                        </svg></a> / <a href="/dashboard/wisata">Manajemen Wisata</a> / Tambah Data
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="card shadow-sm bg-light bg-gradient mb-3">
                        <div class="card-body">
                            ...
                            <hr>
                            <form class="row g-2 responsive-small fw-semibold" method="post" action="/dashboard/wisata"
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-5 position-relative">
                                        ...
                                        <input type="text" id="validationCustom01" class="form-control responsive-small"
                                            name="judul" placeholder="Isi Judul Wisata" required>
                                    </div>
                                    <div class="col-md-4 position-relative">
                                        <label for="validationCustom01" class="form-label">Penulis Wisata<span
                                                class="text-danger">*</span></label>
                                        <input type="text" id="validationCustom01" class="form-control responsive-small"
                                            name="creator" value="{{ Auth::user()->name }}" placeholder="Isi Penulis Wisata"
                                            readonly>
                                    </div>
                                    <div class="col-md-3">
