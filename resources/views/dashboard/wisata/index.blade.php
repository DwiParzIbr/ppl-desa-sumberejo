                    ...
                    <div class="card shadow-sm bg-light bg-gradient mb-3">
                        <div class="card-body">
                            <div class="d-flex">
                                ...
                                <a href="/dashboard/wisata/create" class="btn btn-warning fw-semibold ms-auto"
                                    type="button" data-bss-hover-animate="tada">Tambah Wisata
                                        ...
                                        <tbody>
                                            @foreach ($wisatas as $key => $wisata)
                                                <tr>
                                                    ...
                                                    <td> <img src="{{ asset('images/' . $wisata->thumbnail) }}"
                                                            style="max-width: 150px; height:auto;">
                                                    </td>
                                                    <td>{{ $wisata->judul }}</td>
                                                    <td>{{ $wisata->creator }}</td>
                                                    <td>{!! \Illuminate\Support\Str::limit($wisata->berita, 150, $end = '...') !!}</td>
                                                    <td>
                                                        <a href="/dashboard/wisata/{{ $wisata->id }}"
                                                        ...
                                                        <a href="/dashboard/wisata/{{ $wisata->id }}/edit"
                                                        ...
                                                        <form action="/dashboard/wisata/{{ $wisata->id }}"
